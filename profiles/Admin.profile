...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>The_Membrane</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <classAccesses>
        <apexClass>CompositeGraphWrapper</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>EasyJsonController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>EasyJsonControllerTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MembrameMemory</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MembraneAutomation</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MembraneAutomationTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MembraneDataModelQueueable</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MembraneDataModelQueueableTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MembraneHealthCheckAutomation</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MembraneMutationInterface</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <classAccesses>
        <apexClass>MyJson</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>Osmosis</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>StripeMutationCapsule</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ThrdzCustomLookupController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ThrdzMetadata</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
        <editable>false</editable>
        <field>Membrane_Definition__c.Main_Object__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Membrane_Definition__c.Membrane_Notes__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Membrane_Definition__c.Membrane__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Membrane_Definition__c.Sample_JSON__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Membrane_External_Data_Source__c.Unique_Prefix__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Membrane_Health_Check__c.Composite_Graph_Request__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Membrane_Health_Check__c.Composite_Graph_Result__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Membrane_Health_Check__c.Generated_JSON__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Membrane_Health_Check__c.Membrane__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Membrane_Health_Check__c.Record_Id__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Membrane_Health_Check__c.Sample_JSON__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Membrane_Health_Check__c.Schema_Check_Status__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
        <layout>Membrane_Definition__c-Membrane Definition Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Membrane_External_Data_Source__c-Membrane External Data Source Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Membrane_Health_Check__c-Membrane Health Check Layout</layout>
    </layoutAssignments>
    <loginIpRanges>
    ...
    <objectPermissions>
        ...
        <object>Membrane_Definition__c</object>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>Membrane_External_Data_Source__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>true</allowCreate>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>Membrane_Health_Check__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <tabVisibilities>
        <tab>Membrane_Definition__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
        <tab>Membrane_External_Data_Source__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
        <tab>Membrane_Health_Check__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    ...
    <userPermissions>
        <enabled>false</enabled>
        <name>UseMfgAdvAcctForecastCmty</name>
    </userPermissions>
    <userPermissions>
        <enabled>true</enabled>
